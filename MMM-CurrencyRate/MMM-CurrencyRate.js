Module.register("MMM-CurrencyRate", {
    ...
    start: function () {
        ...
        this.url = "http://data.fixer.io/api/latest?access_key=" + this.config.apiKEY + "&symbols=" + this.config.symbols // + "&base=" + this.config.base;
    ...
    getDom: function () {
        ...
        if (!this.fetched) {
            wrapper.innerHTML = this.translate("Waiting to fetch up to date exchange rates");
